 ...
 * ```
 */
export async function commit(value, blinding) {
    const H = await getH();
...
export async function verify(commitment, value, blinding) {
    try {
        const H = await getH();
        const vG = Point.G.mul(mod(value, Curve.N));
 ...
 * ```
 */
export async function schnorrProve(key, 
...
export async function schnorrVerify(proof, context) {
    try {
 ...
 */
export async function rangeProve(value, bitCount = 32) {
...
export async function rangeVerify(proof, blindings) {
